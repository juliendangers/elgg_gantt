    ...
    $.fn.fcbkcomplete = function (opt) {
        return this.each(function () {
           ...
           //     element.attr("multiple", "multiple");
			...
			/*	
                 $(aclose).attr({               
                    "href": 'http://reseaux.apronet.asso.fr/pg/groups/'+value
                });
            ...
            function addMembers(etext, data) {
                ...
                while (match != null && maximum > 0) {
                    ...
                    if (options.filter_selected && element.children("option[value=" + object.value + "]").hasClass("selected")) {} else {
                        content += '<li rel="' + object.value + '">' + itemIllumination(object, object.caption, etext) + '</li>';
                        counter++;
                        maximum--;
                    }
                    match = myregexp.exec(search_string);
            ...
            function itemIllumination(obj, text, etext) {
                if (options.filter_case) { 
					
                    try {
                        eval("var text = text.replace(/(.*)(" + etext + ")(.*)/gi,'<a href=\"http://reseaux.apronet.asso.fr/pg/groups/" + obj.value + "\">$1<em>$2</em>$3</a>');");
            ...
            function bindEvents() {
				...
				//on redirige l'utilisateur vers le groupe sur lequel il clique
				feed.children("li").click(function() {
					document.href.location = "http://reseaux.apronet.asso.fr/pg/groups/"+option.attr("rel");
				});/*
				on empeche le mousedown qui a lieu avant le click, et empeche donc son execution en cachant la liste
            ...
            var options = $.extend({
                ...
                filter_case: false,
                filter_hide: false,
                complete_text: "Commencez à taper le nom d'un groupe...",
                maxshownitems: 30,
                onselect: "",
                onremove: ""
            }, opt);
