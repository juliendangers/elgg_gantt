 	...
 	function gantt_submenus() {
 		...
 		if(get_context() == 'gantt') {
 			if ((page_owner() == $_SESSION['guid'] || !page_owner()) && isloggedin()) {
 				...
 				if (get_entity(page_owner()) instanceof ElggGroup) 
 				{
 					add_submenu_item(sprintf(elgg_echo("gantt:user"),$page_owner->name), $CONFIG->wwwroot . "pg/gantt/owned/" . $page_owner->username);
 				} 
				else
 				{
